...
| R3 | While the window is active, when f is pressed, the system shall toggle fullscreen; when Escape is pressed in fullscreen, it shall restore the preceding normal or maximized state; when q is pressed, it shall quit. |
